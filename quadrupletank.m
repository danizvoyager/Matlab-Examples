...
Kc=0.5; g=981;delt=0.1;tsim=500;
...
vk=z_k1 - H*xest_k10;
k_k=(p_k10*(H'))/(H*p_k10*H' + R_k0);
%update after measurment
xest_k11=xest_k10 + k_k*vk;
p_k11=(eye(4)- k_k*H)*p_k10;
%controller design
